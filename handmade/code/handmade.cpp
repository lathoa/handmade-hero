...
{    
	...
	v2 PlayerLeftTop =	{PlayerGroundX - MetersToPixels*0.5f*GameState->PlayerWidth,
						 PlayerGroundY - MetersToPixels*GameState->PlayerHeight};
	v2 PlayerWidthHeight = {GameState->PlayerWidth, GameState->PlayerHeight};
